  ...
  es: {
    ...
    software: {
      ...
      faq: [
        ...
        { q: "¿En qué plataformas está disponible?", a: "En escritorio, web y app, con ediciones y licencias de 1 a 150 usuarios y bases de datos por RFC." },
      ],
  ...
  en: {
    ...
    software: {
      ...
      faq: [
        ...
        { q: "Which platforms is it available on?", a: "On desktop, web and app, with editions and licenses from 1 to 150 users and databases per Tax ID." },
      ],
