...
/** Divisor/acento: una línea mint que se dibuja al entrar en vista + un punto que la recorre. */
  ...
  return (
    <div className={`relative h-[2px] w-full ${className}`}>
      ...
      {!reduce && (
        <motion.span
          aria-hidden
          className="signal-glow absolute top-1/2 h-1.5 w-1.5 -translate-x-1/2 -translate-y-1/2 rounded-full bg-accent"
          initial={{ left: "0%" }}
