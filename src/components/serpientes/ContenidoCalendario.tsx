    ...
    <section className="border-t border-[var(--st-line)] bg-[var(--st-surface-1)] px-6 py-24 md:px-10 md:py-40">
      <div className="mx-auto max-w-[1280px]">
        <Reveal className="mb-14 flex flex-wrap items-baseline gap-x-6 gap-y-2 md:mb-20">
          ...
          <h2 className="st-display max-w-[14ch] text-[clamp(28px,5vw,56px)] text-[var(--st-chalk)]">
        ...
        <div className="grid gap-10 md:grid-cols-[1fr_1fr] md:gap-16">
          <Reveal>
            <div className="flex items-baseline gap-3">
              ...
              <h3 className="st-display text-[clamp(24px,4vw,40px)] text-[var(--st-chalk)]">
                {pretemporada.nombre}
              </h3>
            </div>
        ...
        <Reveal className="mt-24 mb-8 flex items-end justify-between gap-6 border-t border-[var(--st-line)] pt-10 md:mt-32">
          <h3 className="st-display text-[clamp(22px,3.5vw,38px)] text-[var(--st-chalk)]">
            Semana tipo
          </h3>
        ...
        <Reveal className="mt-20 md:mt-28" y={40}>
          <div className="relative overflow-hidden border border-[var(--st-red)]/50 bg-[var(--st-void)] px-7 py-12 md:px-12 md:py-16">
            <span
              className="st-display pointer-events-none absolute -right-6 -top-10 select-none text-[160px] leading-none text-[var(--st-red)]/10 md:text-[280px]"
              aria-hidden
            >
              {playoffs.nombre}
            </span>
            <div className="relative">
              ...
              <h3 className="st-display mt-3 text-[clamp(32px,7vw,84px)] leading-[0.92] text-[var(--st-chalk)]">
                {playoffs.nombre}
              </h3>
