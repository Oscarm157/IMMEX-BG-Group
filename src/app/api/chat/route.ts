...
const TOOLS: Tool[] = [
  ...
  },
  {
    ...
    input_schema: {
      ...
      properties: {
        ...
        timeInBusiness: { type: 'string', description: 'Antigüedad operando' },
  ...
  },
  {
    ...
    description:
      'Llama esta herramienta junto con tu respuesta de texto cuando hagas una pregunta de calificación con respuestas cortas predecibles: sector, volumen, tipo de operación, antigüedad, urgencia. NO la llames para preguntas abiertas sobre la situación específica del visitante.',
    input_schema: {
      type: 'object',
      properties: {
        options: {
