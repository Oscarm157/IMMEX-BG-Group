...
export function FeedbackBoard({
  ...
  const exportText = useMemo(() => {
    const lines: string[] = ["# Comentarios del sitio — BG", ""];
      ...
      <section>
        ...
        >
          <input
            ...
            className="min-w-[260px] flex-1 rounded-lg border border-[var(--crm-line)] bg-[var(--crm-surface)] px-3 py-2 text-[13px] text-[var(--crm-ink)] placeholder:text-[var(--crm-ink-soft)] focus:border-[var(--crm-accent)] focus:outline-none"
          />
          <button
            type="submit"
            disabled={pending}
            className="inline-flex items-center gap-1.5 rounded-lg bg-[var(--crm-accent)] px-3 py-2 text-[13px] font-medium text-[var(--crm-accent-ink,#04231a)] transition hover:opacity-90 disabled:opacity-50"
          >
                      ...
                      <div className="flex items-start justify-between gap-3">
                        ...
                        <div className="flex shrink-0 items-center gap-1.5">
                          <button
                            ...
                            className={`rounded-md border px-2 py-1 text-[12px] transition ${
                              n.status === "resolved"
                                ...
                                : "border-[var(--crm-accent)] text-[var(--crm-accent-ink,#0b7d5a)] hover:bg-[var(--crm-surface-3)]"
                            }`}
                          >
                          ...
                          <button
                            ...
                            className="rounded-md border border-[var(--crm-line)] p-1.5 text-[var(--crm-ink-soft)] transition hover:text-red-400"
                            aria-label="Eliminar"
                          >
