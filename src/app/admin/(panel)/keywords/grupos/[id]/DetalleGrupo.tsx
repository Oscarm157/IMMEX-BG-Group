    ...
    <>
      <div className="mb-4 flex flex-wrap items-center gap-1.5">
        ...
        <button
          type="button"
          onClick={copiar}
          className="crm-btn crm-btn-sm crm-btn-secondary ml-auto"
        >
      ...
      {keywords.length === 0 ? (
        <div className="crm-card p-10 text-center">
          <p className="text-[14px] text-[var(--crm-ink-soft)]">El grupo se quedó sin keywords.</p>
        </div>
      ) : (
      ...
      <div className="crm-card p-4">
        <label className="mb-2 block text-[13px] text-[var(--crm-ink-soft)]">Notas del grupo</label>
        <textarea
          value={notas}
      ...
      {confirmaLanzar && (
        ...
        >
          <div className="crm-card w-full max-w-[400px] p-5" onClick={(e) => e.stopPropagation()}>
